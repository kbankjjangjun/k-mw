...
export const bgColorVariants = {
  lime: 'bg-k-lime',
  white: 'bg-white',
  'deep-blue': 'k-deep-blue-300',
} as const

export type BgColorValue = keyof typeof bgColorVariants

export const colorVariants = {
  lime: 'text-k-lime',
  'deep-blue': 'text-k-deep-blue-300',
  black: 'text-black',
} as const

export type ColorValue = keyof typeof colorVariants
